...
namespace MovieRecommenderMLModel_ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\admin\Desktop\WebAPI\MovieRecommender\MovieRecommender\recommendation-ratings-train.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"movieId",inputColumnName:@"movieId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"rating",MatrixColumnIndexColumnName=@"userId",MatrixRowIndexColumnName=@"movieId",ApproximationRank=13,LearningRate=0.102962120682089,NumberOfIterations=258,Quiet=true}))      
